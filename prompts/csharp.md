...
- Tests for trivial timestamp or duration comparisons (`DateTime.Now - lastChange < threshold`) where testing requires mocking the clock or sleep-based waits that produce flaky tests
